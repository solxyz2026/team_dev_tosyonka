...
public interface BookRepository extends JpaRepository<Book, Integer> {
	...
	List<Book> findByTitleContainingIgnoreCaseAndDeleteJudgeFalse(String title);
	...
	//カテゴリのみで検索
	List<Book> findByCategoryIdAndDeleteJudgeFalse(Integer categoryId);
